...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/matched_zplane.png}
\caption{Matched z-transform mapping used in advanced MTI filter design.}
\label{fig:mzt}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{images/spectral_transformation_mappings.png}
\caption{Spectral transformations adapting digital filter responses.}
\label{fig:spectral}
\end{figure}
