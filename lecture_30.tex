...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{images/adaptive_noise_cancellation.png}
\caption{Adaptive Noise Cancellation (ANC) architecture.}
\label{fig:anc}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{images/equalizer_response.png}
\caption{Channel Equalizer frequency responses.}
\label{fig:eq}
\end{figure}
