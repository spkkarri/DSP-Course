...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/fir_window_functions_time_freq.png}
    \caption{Window Functions in Time and Frequency Domains: Mainlobe Width vs. Sidelobe Attenuation Trade-offs.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/gibbs_phenomenon_truncation.png}
    \caption{Gibbs Phenomenon: Abrupt Truncation Overshoot ($8.9\%$) vs. Smooth Hamming Window Suppression.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/fir_filter_design_workflow.png}
    \caption{Step-by-Step Practical FIR Filter Design Procedure using the Window Method.}
\end{figure}
