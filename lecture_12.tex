...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/analog_filter_prototypes.png}
    \caption{Analog Filter Prototypes: Butterworth vs. Chebyshev Magnitude Profiles and Left-Half S-Plane Pole Placement.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/bilinear_s_to_z_mapping.png}
    \caption{Bilinear Transformation Conformal Mapping: Mapping the Left-Half S-Plane into the Stable Interior $|z|<1$.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/frequency_warping_prewarping.png}
    \caption{Frequency Warping Characteristic $\Omega = \frac{2}{T}\tan(\omega/2)$ and Prewarping Strategy.}
\end{figure}
