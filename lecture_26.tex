...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/analog_poles.png}
\caption{Analog anti-aliasing filter pole distributions.}
\label{fig:analog_poles}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{images/analog_responses.png}
\caption{Analog anti-aliasing filter magnitude responses.}
\label{fig:analog_responses}
\end{figure}
