...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{images/window_comparison_shapes.png}
\caption{Oscillator output windowing functions.}
\label{fig:window_comp_shapes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/sidelobe_suppression.png}
\caption{Spur suppression levels under different windows.}
\label{fig:sidelobe_suppression}
\end{figure}
