...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{images/fir_direct_form.png}
\caption{FIR direct-form implementation for Wiener filter.}
\label{fig:fir_direct}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{images/fir_cascade_form.png}
\caption{Alternative FIR cascade-form structure.}
\label{fig:fir_cascade}
\end{figure}
