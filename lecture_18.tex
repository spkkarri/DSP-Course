...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/stft_vs_wavelet_tiling.png}
    \caption{Time-Frequency Tiling: Rigid STFT Grid vs. Adaptive Multiresolution Wavelet Plane.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/dwt_filterbank_mallat.png}
    \caption{Mallat's Pyramidal Multiresolution Discrete Wavelet Transform (DWT) 3-Level Filter Bank.}
\end{figure}
