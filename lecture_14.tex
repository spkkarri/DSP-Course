...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/overlap_save.png}
\caption{Visual analogy: Commutators cleanly slice data in multirate structures.}
\label{fig:overlap_save}
\end{figure}
