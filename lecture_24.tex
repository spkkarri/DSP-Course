...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/speech_production_source_filter.png}
    \caption{Acoustic Speech Production Model: Voiced/Unvoiced Excitation driving Vocal Tract All-Pole Filter.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/lpc_spectral_envelope_tracking.png}
    \caption{Linear Predictive Coding (LPC) Spectral Envelope Tracking Vocal Tract Formant Resonances ($F_1, F_2, F_3$).}
\end{figure}
