...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/periodogram_vs_bartlett_welch.png}
    \caption{Spectral Estimation: Inconsistent Raw Periodogram Variance vs. Smooth Welch Segment Averaging.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/ar_parametric_vs_nonparametric.png}
    \caption{Parametric Autoregressive (AR) All-Pole Model vs. Non-Parametric Welch Spectral Resolution.}
\end{figure}
