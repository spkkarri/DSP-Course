...
\begin{figure}[H]
    ...
    \caption{Sampling the Continuous DTFT Spectrum at $N=8$ Uniform Frequency Angles $\omega_k = \frac{2\pi k}{8}$.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/dft_basis_functions.png}
    \caption{Orthogonal Real (Cosine) and Imaginary (Sine) DFT Harmonic Basis Functions for $N=8$.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/dft_matrix_heatmaps.png}
    \caption{Vandermonde DFT Matrix $W_8$: Visualizing Real and Imaginary Orthogonal Matrix Coefficients.}
\end{figure}
