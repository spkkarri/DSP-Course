...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/fir_linear_phase_efficient_structure.png}
    \caption{Linear-Phase FIR Structural Optimization: Exploiting Symmetry to Save $50\%$ Hardware Multipliers.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/fir_lattice_filter_architecture.png}
    \caption{Multi-Stage FIR Lattice Filter Architecture and Reflection Coefficient Stability Criterion ($|k_m|<1$).}
\end{figure}
