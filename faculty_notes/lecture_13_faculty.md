<Faculty Notes — Lecture 13: Linear Filtering: Overlap-Add (OLA) Method>
...
2. Establish block zero-padding requirement: $N \ge L + M - 1$.
...
5. Derive the optimal block length $L_{\text{opt}}$ that minimizes total computational cost per output sample.
