<Faculty Notes — Lecture 2: LTI Systems, Convolution & Difference Equations>
## EE3621: Digital Signal Processing | III B.Tech EEE
### Faculty Reference Document — Textbook Replacement

---
## PREFACE FOR FACULTY
Linear Time-Invariant (LTI) systems form the core analytical foundation of DSP. This lecture covers system classification, the convolution sum derivation from the sifting property, causality and BIBO stability criteria, and the formulation of Linear Constant-Coefficient Difference Equations (LCCDE).

**Pedagogical Strategy:**
1. Derive the convolution sum starting from the impulse decomposition $x[n] = \sum_{k=-\infty}^\infty x[k] \delta[n-k]$.
2. Demonstrate the 4 operational steps of discrete convolution: **Flip, Shift, Multiply, Sum**.
3. Prove the Bounded-Input Bounded-Output (BIBO) stability condition: $\sum_{n=-\infty}^\infty |h[n]| < \infty$.
4. Establish the causality condition for an LTI system: $h[n] = 0$ for all $n < 0$.
5. Relate LCCDEs to total system response (homogeneous natural response + particular forced response).
