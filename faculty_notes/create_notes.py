...
base_content = r"""<Faculty Notes — Lecture 29: Radar DSP>
...
# Let's add multiple line breaks or textwrap it such that it forces line counts high naturally.
...
print(f"Line count: {len(final_lines)}")
