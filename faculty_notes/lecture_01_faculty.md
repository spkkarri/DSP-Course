<Faculty Notes — Lecture 1: Course Introduction & Discrete-Time Signals>
...
2. Formulate the fundamental sampling relationship $t = n T_s = n / F_s$.
...
5. Highlight the fundamental distinction between continuous and discrete sinusoids: Discrete sinusoidal frequencies are unique only over an interval of length $2\pi$ (e.g., $[-\pi, \pi]$ or $[0, 2\pi]$).
