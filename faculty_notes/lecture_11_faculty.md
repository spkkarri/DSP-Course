...
2. Derive the DIF butterfly: Addition/subtraction occurs *first*, and twiddle factor multiplication is applied to the difference branch *afterwards*.
...
4. Show that cascading a DIT-FFT and DIF-FFT (or vice-versa) allows back-to-back fast convolution without any bit-reversal sorting between stages.
