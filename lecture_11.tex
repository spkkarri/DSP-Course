...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{images/dif_butterfly.png}
\caption{Large FIR filters can be implemented efficiently using block convolution methods which rely on the Fast Fourier Transform (FFT). The butterfly structure of the FFT is shown.}
\label{fig:dif_butterfly}
\end{figure}
