...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{images/moving_average_frequency.png}
\caption{Generic Filter Magnitude Response.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{images/moving_average_zplane.png}
\caption{Z-Plane Filter Representation.}
\end{figure}
