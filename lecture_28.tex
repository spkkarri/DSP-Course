...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/ecg_morphology_and_noise_artifacts.png}
    \caption{Clinical ECG Signal Morphology (P-QRS-T Complex) with Powerline Noise and Baseline Wander Removal.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/pan_tompkins_qrs_detection_pipeline.png}
    \caption{Pan-Tompkins Real-Time 5-Stage QRS / R-Peak Detection Signal Processing Pipeline.}
\end{figure}
