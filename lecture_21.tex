...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/uniform_quantization_error_pdf.png}
    \caption{Uniform Mid-Tread Quantizer Characteristic and Uniform Error PDF Statistical Model ($\sigma_e^2 = \Delta^2/12$).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/sqnr_vs_bitdepth_rule.png}
    \caption{The $6.02\text{ dB/bit}$ Dynamic Range Rule: Linear SQNR Growth with ADC Wordlength.}
\end{figure}
