...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/sampling_frequency_replication.png}
    \caption{Sampling in the Frequency Domain: Spectral Replication and Aliasing Overlap when $\Omega_s < 2\Omega_{max}$.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/aliasing_time_domain_masquerade.png}
    \caption{Time-Domain Aliasing: High-Frequency Sine Wave Masquerading Identically as a Low-Frequency Alias.}
\end{figure}
