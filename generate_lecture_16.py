...
md_content = r"""# Lecture 16: Adaptive Filtering — LMS Algorithm
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/linear_phase_fir.png}
\caption{FIR Filter Structure commonly used as the basis for Adaptive Filters.}
\label{fig:fir_structure}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/frequency_sampling_structure.png}
\caption{Alternative structures like frequency-domain adaptive filters can also be applied in these applications.}
\label{fig:freq_sampling}
\end{figure}
...
with open(r"C:\Users\sriph\Downloads\DSP\lecture_16.md", "w", encoding="utf-8") as f:
    f.write(md_content)

with open(r"C:\Users\sriph\Downloads\DSP\lecture_16.tex", "w", encoding="utf-8") as f:
    f.write(tex_content)
